...
INSERT INTO vpn_servers (key, name, flag, host, port, domain, sni, is_active, sort_order) VALUES
    ('de', 'Germany', '🇩🇪', '162.19.242.30', 2096, '', 'ads.x5.ru', true, 1),
    ('nl', 'Netherlands', '🇳🇱', '194.135.38.90', 2096, '', 'rutube.ru', true, 2),
    ('relay-de', 'Russia → DE', '🇷🇺', '185.218.0.43', 443, '', 'ads.x5.ru', true, 3),
    ('relay-nl', 'Russia → NL', '🇷🇺', '185.218.0.43', 2098, '', 'rutube.ru', true, 4)
