// Minimal subset of v2ray StatsService used to read per-user traffic counters
// from sing-box's experimental.v2ray_api endpoint.
//
// Upstream: https://github.com/v2fly/v2ray-core/blob/master/app/stats/command/command.proto
...
const file_command_proto_rawDesc = "" +
	"\n" +
	"\rcommand.proto\x12\x1cv2ray.core.app.stats.command\";\n" +
	...
	"\x04stat\x18\x01 \x01(\v2\".v2ray.core.app.stats.command.StatR\x04stat\"C\n" +
	...
	"\vGetSysStats\x12-.v2ray.core.app.stats.command.SysStatsRequest\x1a..v2ray.core.app.stats.command.SysStatsResponse\"\x00BAZ?github.com/chameleonvpn/chameleon/internal/vpn/v2rayapi/commandb\x06proto3"
