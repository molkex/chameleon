...
- **⏳ Phase 1.C — Adaptive probe cadence** (planned, требует iOS rebuild): на cellular `TunnelStallProbe.stallThreshold=1` (single degraded → fallback) и `probeInterval=5`s. Сейчас 2/15s = до 30с от throttle до switch. Pure iOS-side. Build 61.
